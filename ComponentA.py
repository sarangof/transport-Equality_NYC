...
Income2013 = pd.read_csv('data/2013 income pc.csv',  header=True, names=["id", "id2block", "block", "PCincome", "error"] , usecols=["id2block", "PCincome"])
Income2013.PCincome = Income2013.PCincome.replace("-", "0")
Income2013.PCincome = Income2013.PCincome.astype(int)
Income2013.head()
Mtrans2013 = pd.read_csv('data/Mean of transportation.csv',  header=True, usecols=[1, 5, 21,37])
...
Costcar2013 = pd.read_excel('data/norteast CES 2013.xlsx',  header=True, usecols=["Item", "New York"])
Costcar2013 = Costcar2013[43:46]
Costcar2013
Carcost = sum(Costcar2013["New York"])
Carcost
Costptrans2013 = pd.read_excel('data/Public transportation costs.xlsx')
Costptrans2013
